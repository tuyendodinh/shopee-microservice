...
Thông tin đăng nhập phải được bảo vệ trong suốt quá trình truyền tải và xử lý.

## Availability

Dịch vụ đăng nhập phải đảm bảo độ sẵn sàng tối thiểu:
...
Thời gian phản hồi trung bình cho một yêu cầu đăng nhập:
...
Tất cả hoạt động đăng nhập phải được ghi nhận và lưu trữ để phục vụ điều tra sự cố và kiểm toán bảo mật.

## Scalability

Hệ thống phải có khả năng phục vụ đồng thời số lượng lớn người dùng mà không ảnh hưởng đáng kể đến hiệu năng.
